...
local function SetUIAccent(color)
    for i, v in pairs(Library.LibraryColorTable) do
        ...
        if HasProperty(v, "TextColor3") then
            if v.TextColor3 ~= Color3.fromRGB(139, 69, 19) then
                v.TextColor3 = color
            end
        end
    end
...
local function RippleEffect(object)
    spawn(function()
        ...
        Ripple.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
...
Topbar.Name = "Topbar"
Topbar.Parent = Main
Topbar.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
...
UITabs.Name = "UITabs"
UITabs.Parent = Main
UITabs.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
...
Tabs.Name = "Tabs"
Tabs.Parent = UITabs
Tabs.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
...
MinIcon.Text = "-"
MinIcon.TextColor3 = Color3.fromRGB(139, 69, 19)
MinIcon.TextSize = 16
...
FloatingText.Text = "W"
FloatingText.TextColor3 = Color3.fromRGB(139, 69, 19)
...
function Library:CreateTab(name)
    ...
    NameTab.Parent = Tabs
    NameTab.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
    ...
    NameTabButton.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
    ...
    function TabElements:CreateSection(name)
        ...
        NameSection.Position = UDim2.new(34, 139, 34.0574162677, 0)
        ...
        SectionTitle.TextColor3 = Color3.fromRGB(139, 69, 19)
        SectionTitle.TextSize = 14.000
        
        SectionContent.Name = "SectionContent"
        SectionContent.Parent = NameSection
        SectionContent.Active = true
        SectionContent.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
        ...
        SectionContentLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
            SectionContent.CanvasSize = UDim2.new(34, 139, 34, SectionContentLayout.AbsoluteContentSize.Y + 15)
        end)
        ...
        function SectionElements:CreateLabel(name, text)
            ...
            NameLabel.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
        ...
        function SectionElements:CreateButton(name, callback)
            ...
            NameButton.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            ButtonRounded.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
        ...
        function SectionElements:CreateToggle(name, callback)
            ...
            NameToggle.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            Toggle.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            Toggle.Text = ""
            Toggle.TextColor3 = Color3.fromRGB(139, 69, 19)
            Toggle.TextSize = 14.000

            CheckboxOutline.Name = "CheckboxOutline"
            CheckboxOutline.Parent = Toggle
            CheckboxOutline.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            CheckboxTicked.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            local function SetState(state)
                if state then
                    TweenService:Create(Title, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(139, 69, 19)}):Play()
                    TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Position = UDim2.new(0.5, 0, 0.5, 0), Size = UDim2.new(34, 139, 34, 0)}):Play()
...
function SectionElements:CreateSlider(name, minimumvalue, maximumvalue, presetvalue, precisevalue, callback)
    ...
    NameSlider.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
    NameSlider.BackgroundTransparency = 1.000
    NameSlider.Position = UDim2.new(34, 139, 34.497237563, 0)
    ...
    CircleSelector.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
    ...
    Value.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
    ...
    Value.TextColor3 = Color3.fromRGB(139, 69, 19)
    ...
    callback(StartingValue)
        ...
        function SectionElements:CreateColorPicker(name, presetcolor, callback)
            ...
            local OldToggleColor = Color3.fromRGB(34, 139, 34)
            local OldColor = Color3.fromRGB(34, 139, 34)
            ...
            NameColorPicker.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            NameColorPicker.BackgroundTransparency = 1.000
            NameColorPicker.Position = UDim2.new(34, 139, 34.138121545, 0)
            ...
            ColorPickerToggle.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            ColorRound.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            ColorRound.SliceCenter = Rect.new(85, 107, 47, 128)
            ColorRound.SliceScale = 0.050
    
            ColorSelection.Name = "ColorSelection"
            ColorSelection.Parent = Color
            ColorSelection.AnchorPoint = Vector2.new(0.5, 0.5)
            ColorSelection.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            RainbowToggleTitle.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            Toggle.Font = Library.Theme.TextFont
            Toggle.Text = ""
            Toggle.TextColor3 = Color3.fromRGB(34, 139, 34)
            Toggle.TextSize = 14.000
            ...
            Hue.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            HueSelection.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            Toggle.MouseButton1Down:Connect(function()
                ...
                if RainbowColorPicker then              
                    TweenService:Create(RainbowToggleTitle, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(139, 69, 19)}):Play()
                    TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Position = UDim2.new(0.5, 0, 0.5, 0), Size = UDim2.new(34, 139, 34, 0)}):Play()
                    TweenService:Create(CheckboxOutline, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = Library.Theme.MainColor}):Play()
                    TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = Library.Theme.MainColor}):Play()
                    ...
                    while RainbowColorPicker do
                        ...
                        ColorSelection.Position = UDim2.new(1, 34, 139, 34)
    ...
    local SelectedOption = options[1]
            ...
            NameDropdown.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            NameDropdown.BackgroundTransparency = 1.000
            NameDropdown.Position = UDim2.new(34, 139, 34.773480654, 0)
            ...
            TitleToggle.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            TitleToggle.TextColor3 = Color3.fromRGB(139, 69, 19)
            ...
            local function ResetAllDropdownItems()
                for i, v in pairs(Dropdown:GetChildren()) do
                    if v:IsA("TextButton") then
                        TweenService:Create(v, TweenInfo.new(0.25, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(139, 69, 19)}):Play()
                    end
                end
            end
            ...
            local function ClearAllDropdownItems()
                ...
                TweenService:Create(TitleToggle, TweenInfo.new(0.5, Library.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(139, 69, 19)}):Play()
            ...
            for i, v in pairs(options) do
                ...
                NameButton.Text = v
                NameButton.TextColor3 = Color3.fromRGB(139, 69, 19)
        ...
        function SectionElements:CreateKeybind(name, presetbind, keyboardonly, holdmode, callback)
            ...
            NameKeybind.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            NameKeybind.BackgroundTransparency = 1.000
            NameKeybind.Position = UDim2.new(34, 139, 34.138121545, 0)
            ...
            KeybindButton.BackgroundColor3 = Color3.fromRGB(139, 69, 19)
            ...
            KeybindButton.TextColor3 = Color3.fromRGB(139, 69, 19)
